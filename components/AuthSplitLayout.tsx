...
const MODE_CONFIG: Record<AuthMode, ThemeConfig> = {
  login: {
    ...
    navLinkLabel: "",
    navLinkTo: "",
    showcaseEyebrow: "Espacio de propietario",
    showcaseTitle: "Tarjetas que viven en el navegador.",
    showcaseCopy: "Mantén campañas, tarjetas emitidas y visitas de retorno en un solo lugar sin enviar a los clientes a una tienda de apps.",
    showcaseSlug: "/stampee",
    card: {
      eyebrow: "Visitas repetidas",
      title: "Lanza, sella, retén.",
      copy: "Usa un enlace de marca para emitir tarjetas de fidelidad y observa la actividad en tiempo real.",
      list: ["Control de campañas", "Enlace listo para clientes", "Actividad de fidelidad en vivo"],
      className: "bg-[linear-gradient(180deg,#bc7d2a_0%,#8e5520_100%)] text-white shadow-[0_38px_120px_-60px_rgba(57,29,6,0.65)]",
    },
    accent: {
      title: "Emitir en segundos",
      copy: "Las tarjetas se abren en el navegador y están listas para sellar de inmediato.",
      className: "bg-[linear-gradient(180deg,#d92de1_0%,#bd21d5_100%)] text-white shadow-[0_26px_90px_-48px_rgba(133,9,151,0.65)]",
      icon: Ticket,
    },
    utility: {
      title: "Vista de campaña",
      value: "Activo",
      rows: ["Rendimiento de oferta", "Revisitas de clientes", "Cola de emisión"],
    ...
    pills: [
      ...
      { label: "Panel del propietario", className: "bg-white/88 text-[#3c342a]", icon: WalletCards },
      { label: "Tarjeta en navegador", className: "bg-white/72 text-[#3c342a]", icon: QrCode },
    ],
  ...
  signup: {
    leftBg: "bg-[#f2efe8]",
    rightBg: "bg-[#c79b2f]",
    navLinkLabel: "Iniciar sesión",
    navLinkTo: "/login",
    showcaseEyebrow: "Lanza más rápido",
    showcaseTitle: "Lanza la fidelidad digital en minutos.",
    showcaseCopy: "Reclama tu enlace de tarjeta de marca, configura el espacio y comienza a emitir tarjetas de fidelidad sin impresión ni instalaciones.",
    showcaseSlug: "/yourbrand",
    card: {
      eyebrow: "Tiempo de configuración",
      title: "Del registro al enlace de tarjeta en un solo flujo.",
      copy: "Crea el espacio de propietario, reserva la URL pública y estate listo para clientes el mismo día.",
      list: ["Gratis para empezar", "URL pública personalizada", "Sin impresión de tarjetas"],
      className: "bg-[linear-gradient(180deg,#c98a39_0%,#9d6325_100%)] text-white shadow-[0_38px_120px_-60px_rgba(57,29,6,0.65)]",
    },
    accent: {
      title: "URL pública personalizada",
      copy: "Reserva el enlace de marca que los clientes guardarán y volverán a visitar.",
      className: "bg-[linear-gradient(180deg,#d92de1_0%,#bd21d5_100%)] text-white shadow-[0_26px_90px_-48px_rgba(133,9,151,0.65)]",
      icon: QrCode,
    },
    utility: {
      title: "Espacio listo",
      value: "El mismo día",
      rows: ["Configuración de propietario", "Portal listo para personal", "Estado de lanzamiento en vivo"],
    ...
    pills: [
      ...
      { label: "Gratis para empezar", className: "bg-white/88 text-[#3c342a]", icon: ArrowUpRight },
      { label: "Sin descargas", className: "bg-white/72 text-[#3c342a]", icon: WalletCards },
    ],
  ...
  staff: {
    leftBg: "bg-[#f4eee7]",
    rightBg: "bg-[#b2781f]",
    navLinkLabel: "Acceso de propietario",
    navLinkTo: "/login",
    showcaseEyebrow: "Acceso de equipo",
    showcaseTitle: "Acceso de personal rápido y seguro.",
    showcaseCopy: "El personal puede iniciar sesión con correo, PIN e ID de organización, y pasar directamente a los flujos de emisión y quiosco.",
    showcaseSlug: "/brand/staff",
    card: {
      eyebrow: "Portal de personal",
      title: "Protegido por PIN, vinculado al propietario.",
      copy: "Mantén el acceso del personal separado de la configuración del propietario, listo para el tráfico de cola y quiosco.",
      list: ["Correo + PIN", "Acceso por organización", "Flujo listo para quiosco"],
      className: "bg-[linear-gradient(180deg,#9c5324_0%,#6d3418_100%)] text-white shadow-[0_38px_120px_-60px_rgba(49,19,4,0.7)]",
    },
    accent: {
      title: "Escanear y emitir",
      copy: "Pasa de la cola a la tarjeta del cliente en pocos toques.",
      className: "bg-[linear-gradient(180deg,#2440d1_0%,#13279a_100%)] text-white shadow-[0_26px_90px_-48px_rgba(16,34,123,0.7)]",
      icon: ScanLine,
    },
    utility: {
      title: "Verificación de org.",
      value: "Verificado",
      rows: ["Acceso por PIN", "Traspaso a quiosco", "Inicio de sesión de personal"],
    ...
    pills: [
      ...
      { label: "Acceso por PIN", className: "bg-white/88 text-[#3c342a]", icon: ShieldCheck },
      { label: "Listo para quiosco", className: "bg-white/72 text-[#3c342a]", icon: ScanLine },
    ],
