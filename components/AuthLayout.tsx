...
const THEME_CONFIG = {
  login: {
    ...
    metrics: [
      { label: "Tarjetas emitidas", value: "12k+" },
      { label: "Visitas repetidas", value: "+24%" },
    ],
    quote: "Hecho para cafeterías, panaderías y marcas locales que quieren fidelidad sin el papeleo.",
    features: [] as string[],
    navLinkLabel: "Crear cuenta",
    navLinkTo: "/signup",
  },
  signup: {
    blobA: "bg-sky-200/40",
    ...
    metrics: [
      { label: "Tiempo de configuración", value: "3 min" },
      { label: "Personal incorporado", value: "5k+" },
    ],
    quote: "Perfil de marca, tarjetas de fidelidad y analítica — todo en un lugar, listo en minutos.",
    features: ["Perfil de marca", "Tarjetas de fidelidad", "Analítica"],
  ...
  staff: {
    ...
    blobC: "bg-sky-100/30",
    metrics: [
      { label: "Escaneos hoy", value: "30k+" },
      { label: "Tiempo prom. de emisión", value: "12 seg" },
    ],
    quote: "Sella tarjetas rápido y con precisión — sin papel, sin complicaciones, solo servicio fluido.",
    features: [] as string[],
